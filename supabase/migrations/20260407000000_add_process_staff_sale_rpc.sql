-- process_staff_sale: Atomic POS sale with points, exchange, and transaction tracking
...
BEGIN
  ...
  INSERT INTO sales (
    ...
    p_business_id, p_customer_id, p_staff_id, v_sale_number,
  ...
  VALUES (p_business_id, p_staff_id, p_customer_id, v_points_earned, v_total_centavos);
