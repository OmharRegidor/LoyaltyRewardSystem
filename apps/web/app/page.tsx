            ...
            <div>
              ...
              <div className="mt-6">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-3 px-4 py-2.5 bg-white/[0.08] border border-white/15 rounded-xl hover:bg-white/[0.14] hover:border-white/25 transition-all group"
                >
                  ...
                  <div className="leading-tight">
                    <span className="text-white/50 text-[10px] block">Download on the</span>
                    <span className="text-white font-semibold text-sm group-hover:text-white/90">App Store</span>
                  </div>
                </a>
              </div>
            </div>
