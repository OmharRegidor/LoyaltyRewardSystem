    ...
    <div className="relative min-h-screen overflow-hidden bg-[#FDFBF7]">
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 py-16">
        ...
        >
          ...
          <div className="relative flex items-center gap-3 rounded-xl border border-[#7F0404]/20 bg-gradient-to-r from-[#7F0404] to-[#9a0808] px-8 py-4 font-[var(--font-space-grotesk)] text-base font-bold tracking-wide text-white shadow-lg transition-all duration-300 group-hover:scale-[1.02] group-hover:shadow-[0_8px_40px_rgba(127,4,4,0.35)] sm:px-10 sm:py-5 sm:text-lg">
            <svg
        ...
        <p className="mb-16 text-center font-[var(--font-plus-jakarta-sans)] text-xs text-[#1a0a0a]/30">
          Android APK &middot; Requires Android 8.0+
        </p>
