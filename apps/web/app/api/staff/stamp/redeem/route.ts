// apps/web/app/api/staff/stamp/redeem/route.ts
...
export async function POST(request: Request) {
  try {
    ...
    const { data, error } = await service.rpc('redeem_stamp_card', {
    ...
    const message = error instanceof Error ? error.message : 'Failed to redeem stamp card';
