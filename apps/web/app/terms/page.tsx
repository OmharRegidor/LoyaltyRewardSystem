      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <section className="mb-10">
          ...
          <p className="text-foreground/80 leading-relaxed">
            Welcome to NoxaLoyalty (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or
            &ldquo;us&rdquo;). These Terms of Service (&ldquo;Terms&rdquo;)
            govern your access to and use of the NoxaLoyalty platform, including
            our website at noxaloyalty.com, mobile applications, and related
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 space-y-2 text-foreground/80">
            <li>
              <strong>&ldquo;Business Owner&rdquo;</strong> refers to
              individuals or entities who register to use NoxaLoyalty to create
              and manage loyalty programs for their customers.
            </li>
            <li>
              <strong>&ldquo;Staff&rdquo;</strong> refers to employees or
              representatives of a Business Owner who are granted access to use
              certain features of the Service.
            </li>
            <li>
              <strong>&ldquo;Customer&rdquo;</strong> refers to end-users who
              participate in loyalty programs through our mobile application.
            </li>
            <li>
              <strong>&ldquo;Points&rdquo;</strong> refers to the virtual
              currency earned and redeemed within the loyalty program.
            </li>
            <li>
              <strong>&ldquo;Rewards&rdquo;</strong> refers to the benefits,
              discounts, or items that can be redeemed using Points.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-foreground/80 leading-relaxed">
            ...
            account. Customers must be at least 13 years old to use the mobile
            application. By using the Service, you represent that you meet these
            age requirements.
          </p>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 space-y-2 text-foreground/80 mt-4">
            ...
            <li>Staff to process transactions and award points to customers</li>
            <li>
        ...
        <section className="mb-10">
          ...
          <p className="text-foreground/80 leading-relaxed">
            Points are earned based on the rules set by each Business Owner. The
            rate of earning and any bonuses (such as tier multipliers) are
            determined by the Business Owner&apos;s configuration.
          </p>
          ...
          <p className="text-foreground/80 leading-relaxed">
            Points have no cash value and cannot be exchanged for cash. Points
            can only be redeemed for rewards offered by the issuing Business
            Owner.
          </p>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 space-y-2 text-foreground/80 mt-4">
            ...
            <li>Manipulate or falsify transaction data or point balances</li>
            <li>
              Share QR codes or account credentials with others to fraudulently
              earn points
            </li>
            <li>
        ...
        <section className="mb-10">
          ...
          <p className="text-foreground/80 leading-relaxed">
            ...
            are owned by NoxaLoyalty and are protected by international
        ...
        <section className="mb-10">
          ...
          <p className="text-foreground/80 leading-relaxed">
            You agree to indemnify and hold harmless NoxaLoyalty, its officers,
            directors, employees, and agents from any claims, damages, losses,
            liabilities, costs, or expenses (including reasonable
            attorneys&apos; fees) arising from your use of the Service or
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 space-y-2 text-foreground/80 mt-2">
            ...
            <li>
              Business data may be deleted after 30 days (for Business Owners)
            </li>
