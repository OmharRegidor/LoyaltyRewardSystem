...
import { Home, Users, Gift, QrCode, BarChart3, Settings, LogOut, X, Moon, Sun } from "lucide-react"
  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex items-center justify-between border-b border-border">
        <h1 className="text-2xl font-bold gradient-primary bg-clip-text text-transparent">LoyaltyHub</h1>
        <button onClick={onClose} className="lg:hidden p-1 hover:bg-muted rounded transition">
          <X className="w-5 h-5" />
        </button>
      </div>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active ? "bg-primary text-primary-foreground shadow-lg" : "text-foreground hover:bg-muted",
              )}
            >
