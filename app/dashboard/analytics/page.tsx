    ...
    <DashboardLayout>
      <motion.div className="space-y-8" initial="hidden" animate="visible" variants={containerVariants}>
        ...
        <motion.div className="grid grid-cols-1 lg:grid-cols-2 gap-6" variants={containerVariants}>
          ...
          <motion.div variants={itemVariants}>
            <Card className="p-6">
              <h2 className="text-xl font-bold mb-6">Monthly Revenue & Points Issued</h2>
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={monthlyRevenueData}>
                  ...
                  <Bar dataKey="points" fill="var(--color-secondary)" radius={[8, 8, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </Card>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            <Card className="p-6">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
                  <Pie data={customerSegmentData} cx="50%" cy="50%" innerRadius={80} outerRadius={120} dataKey="value">
                ...
                {rewardPerformanceData.map((item, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-muted rounded-lg">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">{item.redemptions} redemptions</p>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Free Coffee rewards drive 45% of redemptions</p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">High-value customers increased 25% this quarter</p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">93% weekly retention rate, highest in 6 weeks</p>
                </div>
              </div>
              <div className="flex gap-3">
                <Gift className="w-5 h-5 text-warning flex-shrink-0 mt-1" />
                <div>
                  <p className="font-medium">Opportunity</p>
                  <p className="text-sm text-muted-foreground">5% inactive customers could be re-engaged</p>
                </div>
              </div>
            </div>
          </Card>
